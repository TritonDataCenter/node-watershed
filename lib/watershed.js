...
ws_connect(res, socket, head, wskey)
{
	/*
...
ws_end(reason)
{
	...
	if (reason) {
		...
		this._ws_writeFrameCommon(OPCODE.CLOSE, new Buffer(reason,
		    'utf8'));
	} else {
		this._ws_writeFrameCommon(OPCODE.CLOSE, new Buffer(0));
	}
}
